        ...
        {LABELS.map((label) => (
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <span className="rounded-full border border-black/10 px-2 py-0.5 font-mono text-[9px] text-[#9595A0]">
            ...
            <div className="mt-3">
              ...
              <div className="mt-2 flex items-center gap-3 text-xs text-[#72727E]">
            ...
            <div className="mt-3 flex flex-wrap gap-1">
              {label.genres.map((g) => (
                <span key={g} className="rounded-full bg-black/4 px-2 py-0.5 text-[9px] text-[#9595A0]">
                  {g}
                </span>
              ))}
            </div>

            <div className="mt-3 border-t border-black/7 pt-3 text-[10px] text-[#9595A0]">
              {label.artists.join(" · ")}
            </div>
          </div>
        ))}
